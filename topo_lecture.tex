...
\begin{thm}{}{}
    ...
    \[\Phi\colon \pi_n(Y,ye \to \pi_n(Z,z))\]
...
\begin{construction}
    For every space \(Y\), the set of homotopy classes of maps \([Y, K(A,n)]\) becomes an abelian group via
    \[+ \colon [@, K(A,n)]\times [Y, K(A,n)] \to [Y, K(A,n)]\]
