...
\begin{proof}
    ...
    \begin{description}
        ...
        sends \(f\) to \(\phi\circ \pi_n(f)\colon \pi_n(Y, *)\to A\). So again by theorem \ref{thm:pullbacknicecase}, the composite is bijective. Also \(\Phi\) and \(h^*\) are bijective. So the first map is bijective
